...
# Convert the snowpawk dataframe to a pandas dataframe so we can use the LOC function.
...
#st.write('', order_name)
#st.write('Congrats', +order_name+ ', you have placed your order!')
